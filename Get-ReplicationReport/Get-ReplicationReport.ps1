...
# 
# To ignore any folders in a DeletePending state (useful when you have a lot of folders
# pending deletion and generating false positives):
# 
...
{
    $foldersNotInSync | Export-Csv $Outfile -NoTypeInformation
}
else
{
    $foldersNotInSync
